...
public class Edge {
    ...
    /**
     * Test whether two edges are equals (when the two incident vertices do
     * coincide)
     */
    ...
    /**
     * Given an edge e={u,v} and a vertex u, it returns vertex v (the other
